			...
			**************************************************************************** */
			...
			else
			{
				...
				try
				{
					...
					$sqlinsert = 'INSERT INTO customer (customeremail, customerfirstname, customerlastname, customeraddress, customercity, customerstate, customerzip, customerpassword, customerphone)
								  VALUES (:bvemail, :bvfirstname, :bvlastname, :bvaddress, :bvcity, :bvstate, :bvzip, :bvpass, :bvphone)';
